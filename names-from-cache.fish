...
filter_names "\.tiktok|tiqcdn|ttcdn|ttwstatic|ttoversea|sgsnssdk|byteimg|ibyteimg|musical\.ly|isnssdk|byteglb|bytesover|bytedance|byted\.org|bytegecko|hypstarcdn|pstatp" 'tiktok'
